...
public class IntakeConstants {
    public static final class intakeConstants {
        ...
        public static final double CollectPosition = 0.93;
        public static final double StowedPosition = 0.705;

        public static final double IntakeShootingPosition = 0.79;
        ...
        public static final double intakeMin = 0.70;
